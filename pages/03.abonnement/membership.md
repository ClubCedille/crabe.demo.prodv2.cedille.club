...
introduction:
    ...
    description:
        - 'Nous offrons notre atelier aux membres de la communauté de l''ÉTS (étudiant(e), professeur(e), personnel, etc.).  Notre atelier est l''endroit idéal pour ceux et celles qui cherchent réparer son vélo sans se ruiner. Fondée en 2007, l''atelier est géré par un regroupement d''étudiant(e)s passionné(e)s par le vélo.'
...
advantages:
    ...
    items:
        -
            ...
            description: 'Nous mettons à votre disposition un atelier de vélo de niveau professionnel ayant plusieurs d''outils spécialisés nécessaires pour que vous puissiez entretenir et réparer votre vélo.'
        -
            icon: ⚙️
...
procedure:
    ...
    steps:
        ...
        -
            ...
            description: 'Si vous êtes un nouveau abonné ou une nouvelle abonnée, vous devez participer à une séance de formation avec un membre du C.R.A.B.E. Vous serez contacté par courriel suite à votre achat d''abonnement. Selon votre statut, vous devez aussi compléter la formation de base et sécurité (à votre rhythme).'
        -
            title: 'Profiter de l''accès'
            description: 'Dès que votre accès est programmé sur votre carte ÉTS, vous pourrez accèder notre atelier et commencer d''entretenir et réparer votre vélo !'
menu: Abonnement
---
